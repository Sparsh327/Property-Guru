...
class ProgressButton extends StatefulWidget {
  ...
  factory ProgressButton.icon({
    ...
    if (textStyle1 == null) {
      textStyle1 = TextStyle(color: Colors.indigo, fontWeight: FontWeight.w500);
    }
    ...
    Map<ButtonState, Widget> stateWidgets = {
      ButtonState.idle: buildChildWithIcon(
          iconedButtons[ButtonState.idle], iconPadding, textStyle1),
      ButtonState.loading: Column(),
      ButtonState.fail: buildChildWithIcon(
          iconedButtons[ButtonState.fail], iconPadding, textStyle2),
      ButtonState.success: buildChildWithIcon(
          iconedButtons[ButtonState.success], iconPadding, textStyle3)
    };
