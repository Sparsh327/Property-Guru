...
class _DynamicDetailState extends State<DynamicDetail> {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: NetworkImage(widget.ds["Img"]),
                fit: BoxFit.cover,
              ),
            ),
            child: Container(
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      "FOR " + widget.ds["Lable"].toUpperCase(),
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 14,
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: ListView(
                          ...
                          children: [
                            SizedBox(width: 10),
                            buildPhoto("assets/bed_room.jpg"),
                            buildPhoto("assets/bed_room.jpg"),
                            buildPhoto("assets/bath_room.jpg"),
                          ]),
                    ),
                  ),
                ],
  ...
  makingPhoneCall(String url) async {
